	...
	tests := []controllerTest{
		{
			...
			expectedListCalls: []listCall{{"snapuid-vsc-only-1", map[string]string{"foo": "bar"}, true, time.Now(), 1, nil, ""}},
			expectSuccess:     true,
	...
	tests := []controllerTest{
		{
			...
			expectedListCalls: []listCall{{"snapuid-lifecycle-1", map[string]string{"foo": "bar"}, true, time.Now(), 1, nil, ""}},
			expectSuccess:     true,
			initialSecrets:    []*v1.Secret{secret()},
			errors:            noerrors,
			test:              testSyncContent,
	...
	tests := []controllerTest{
		{
			...
			expectedListCalls: []listCall{{"snapuid-no-vs-1", map[string]string{"foo": "bar"}, true, time.Now(), 1, nil, ""}},
			expectSuccess:     true,
			initialSecrets:    []*v1.Secret{secret()},
			errors:            noerrors,
			test:              testSyncContent,
	...
	tests := []controllerTest{
		{
			...
			expectedListCalls: []listCall{{"snapuid-recreate-1", map[string]string{"foo": "bar"}, true, time.Now(), 1, nil, ""}},
			expectSuccess:     true,
			initialSecrets:    []*v1.Secret{secret()},
			errors:            noerrors,
			test:              testSyncContent,
